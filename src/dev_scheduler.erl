...
find_process_message(ProcID, Msg1, ToSched, Opts) ->
    ...
    case MaybeProcessMsg of
        not_found ->
            ToSchedIsProc =
                (ToSched =/= undefined) andalso
                (hb_message:id(ToSched, all) == ProcID),
...
read_local_assignments(ProcID, CurrentSlot, To, Opts) ->
    case dev_scheduler_cache:read(ProcID, CurrentSlot, Opts) of
        not_found ->
            ...
            [];
        {ok, Assignment} ->
            [Assignment | read_local_assignments(
                            ProcID,
                            CurrentSlot + 1,
                            To,
                            Opts)]
...
benchmark_suite_test_() ->
    {timeout, 10,
              fun() ->
                      ...
                      Bench = [{benchmark, "benchmark", fun single_resolution/1},
